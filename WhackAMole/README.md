...
### GameManager.cs
Gère les informations globales du jeu, notamment le score.  
Implémenté sous forme de singleton pour être accessible partout.

### TaupeTarget.cs
Script attaché aux cibles.  
Détecte les collisions avec le marteau et déclenche les actions (score et destruction).

### Marteau.cs
Permet l’interaction avec les objets.  
Utilise les composants du XR Interaction Toolkit pour le « grab ».
